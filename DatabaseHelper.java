...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    //nama database
    public static final String DATABASE_NAME = "DataPenduduk.db";

    //nama table
    public static final String TABLE_NAME = "Penduduk_table";
    ...
    public Cursor getAllData() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select * from penduduk_table", null);
        return res;
    }
